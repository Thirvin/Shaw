...
public class DialogueUtility : MonoBehaviour
{
    ...
    //test
    private const string PLAYER_NAME_REGEX_STRING = "<pname>";
    ...
    public static List<DialogueCommand> ProcessInputString(string message, out string processedMessage)
    {
        ...
        processedMessage = HandlePlayerNameTags(processedMessage, result);
    ...
    private static string HandlePlayerNameTags(string processedMessage, List<DialogueCommand> result)
    {
        processedMessage = Regex.Replace(processedMessage, PLAYER_NAME_REGEX_STRING, PlayerManager.Instance.playerName);
        return processedMessage;
    }
